 <?php include_once "includes/header.php";
  ...
  if (!empty($_POST)) {
    ...
    if (empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || $_POST['precio'] <  0 || empty($_POST['cantidad'] || $_POST['cantidad'] < 0)) {
      ...
      $query_insert = mysqli_query($conexion, "INSERT INTO producto(proveedor,descripcion,precio,existencia,imgproduct,usuario_id) values ('$proveedor', '$producto', '$precio', '$cantidad','$imgproduct','$usuario_id')");
      if ($query_insert) {
