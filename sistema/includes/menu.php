...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		<div class="sidebar-brand-icon rotate-n-15">
			<img src="img/super.png" class="img-thumbnail">
		</div>
		<div class="sidebar-brand-text mx-3">MiniSuper</div>
	</a>
	...
	<li class="nav-item">
		...
		<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="lista_bebidas.php">Bebidas</a>
				<a class="collapse-item" href="lista_frutas.php">Frutas</a>
				<a class="collapse-item" href="lista_carne.php">Carne</a>
				<a class="collapse-item" href="lista_granos.php">Grano</a>
				<a class="collapse-item" href="lista_vegetales.php">Vegetales</a>
			</div>
		</div>
	</li>
	...
	<li class="nav-item">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseComentario" aria-expanded="true" aria-controls="collapseUtilities">
		<i class="fas fa-address-card"></i>
			<span>Comnetarios</span>
		</a>
		<div id="collapseComentario" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="lista_comentario.php">Comentarios de clientes</a>
			</div>
		</div>
	</li>	
