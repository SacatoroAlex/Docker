...
if(isset($_POST['signupSubmit'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?'reguser.php':'registration.php';
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				...
				<br/><br/>Saludos,
                <br/>Para más desarrollos como este vísitame en mi sitio , atentamente
                <br/>Alex Sacatoro
                <br/>---';                ;
				...
				//additional headers
				$headers .= 'From: ConfiguroWeb<ejemplo@gmail.com>' . "\r\n";
				//send email
	...
	//store reset password status into the session
    $_SESSION['sessData'] = $sessData;
    $redirectURL = ($sessData['status']['type'] == 'success')?'reguser.php':'resetPassword.php?fp_code='.$fp_code;
